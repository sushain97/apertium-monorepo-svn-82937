...
import com.gsoc.apertium.translationengines.router.ondemandservers.IOnDemandServerInterface;
import com.gsoc.apertium.translationengines.router.ondemandservers.OnDemandServerInterfaceFactory;
...
public class DynamicServerManagement {
     ...
     */
   public  List<TranslationServerId> processPlacementControllerResult(Map<LanguagePair, LanguagePairInfo> languagePairsInfo, Map<LanguagePair, Map<TranslationServerId, Integer>> loadDistributionMatrix) {
        ...
        synchronized(this)
        {
            ...
            for(LanguagePairInfo lpi: languagePairsInfo.values())
