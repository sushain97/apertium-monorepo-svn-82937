...
document.write('<select id="s" name="s" tabindex="-1" onchange="insertAtCursor(this);"><option value="s">s</option><option value="ș">ș</option><option value="Ș">Ș</option></select>');
document.write('<select id="t" name="t" tabindex="-1" onchange="insertAtCursor(this);"><option value="t">t</option><option value="ț">ț</option><option value="Ț">Ț</option></select>');
