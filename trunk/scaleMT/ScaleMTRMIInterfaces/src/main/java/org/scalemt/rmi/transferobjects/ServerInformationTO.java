...
public class ServerInformationTO implements Serializable {
    ...
    private Set<DaemonConfiguration> supportedConfigs;
    private Map<LanguagePair, Integer> trashNeededToFlush;
    /**
    ...
    public Map<LanguagePair, Integer> getTrashNeededToFlush() {
        return trashNeededToFlush;
    }

    public void setTrashNeededToFlush(Map<LanguagePair, Integer> trashNeededToFlush) {
    ...
    public void setSupportedConfigs(Set<DaemonConfiguration> supportedConfigs) {
