...
/**
 * {@link IApplicationRouter} implementation.
 * @author vitaka
 */
public class ApplicationRouterImpl implements IApplicationRouter {

    @Override
    public void addServer(TranslationServerId id)  {
       LoadBalancer.getInstance().addTranslationEngine(id);
    }
