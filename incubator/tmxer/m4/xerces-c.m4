dnl @synopsis rlc_XERCESC
dnl attached what is currently being used for Xerces detection. It's far from 
dnl perfect (but WFM) and mostly reaped from the iconv/gettext equivalent.
dnl Like I said: WFM (Works For Me)
dnl @author Ronald Landheer-Cieslak <ronald=landheer.com>
