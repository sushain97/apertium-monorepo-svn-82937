...
cat $rul1"1.dix" | sort | uniq | python di.py dix/apertium-fin-est.fin-est.dix "generated from udt 1"  > dix/apertium-fin-est.fin-est1.udt.dix 
...
cat $rul2"-ls1.dix" | sort | uniq | python di.py dix/apertium-fin-est.fin-est1.dix "generated from testset 1"  > dix/apertium-fin-est.fin-est2.udt.dix 

# compile apertium-fin-est system with dix2
cp -f dix/apertium-fin-est.fin-est2.udt.dix ../../apertium-fin-est.fin-est.dix
cd ../..
make
cd dev/lexind
