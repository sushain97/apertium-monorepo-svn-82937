...
def extractTranslations():
    ...
    for noun in nounList:
        ...
        startPoint = curSource.find("=Noun=", curSource.find("=Dutch="))
...
def getListNouns():
    ...
    while True:
        ...
        curPage = fetcher.open("http://en.wiktionary.org/w/index.php?&action=render&title=Category:Dutch_nouns&from=" + startword)
        curSource = curPage.read()
        curPage.close()
