...
/*
	...
	Input1: Generated list from step 3 - GOOD TRANSLATIONS
	Input2: Bidix entries (from the beginning when we output only lemmas from)
	
	Output: Generated bidix entries for the the GOOD ONES


*/


	$content1 = file_get_contents("Found-intersect.txt", "r");
